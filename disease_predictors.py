...
def process(symes):
    ...
    predicted=predict[0]
    print(predicted)
    predict1 = clf1.predict(inputtest)
    predicted1=predict1[0]
    print(predicted1)
    predict2 = clf2.predict(inputtest)
    predicted2=predict2[0]
    print(predicted2)

    h='no'
    
    if predicted==predicted1==predicted2:
        predicted3= predicted
    elif predicted == predicted1:
        predicted3= predicted1
    elif predicted ==predicted2:
        predicted3= predicted2
    elif predicted1 == predicted2:
        predicted3= predicted1
    else:
        predicted3= predicted
    ...
    return dis,predicted3
disease,did=process(['internal_itching','lack_of_concentration','loss_of_appetite','loss_of_smell'])
